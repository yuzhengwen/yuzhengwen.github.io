...
<script type="text/javascript" src="http://s.sharethis.com/loader.js"></script>
    ...
    <body onload="setUpSlider(); autoSlide();">
        ...
        <div id="wrapper">
            ...
            <br>
            <div id="content">
                <h2>YRom POWER Edition: Release the POWER!</h2>
				<p>
				<a href="http://forum.xda-developers.com/z3/development/release-power-t3251066/post63877110#post63877110">LINK TO XDA THREAD FOR MORE INFO</a>
				<br>
				<br>
				<u>Downloads: </u>
				<br>
				<a href="https://www.androidfilehost.com/?w=files&flid=43434">AndroidFileHost</a>
				<br>
				<a href="">Mega</a>
				<br>
				<br>
				...
				<ul>
					...
					<li> Heavily debloated</li>
					<li> Busyboxed</li>
					<li> Zipaligned</li>
					<li> AROMA Installer-->Choice for Xposed, SuperSU, Camera, some apps, etc</li>
					<li> AndroPlus Kernel for UB and XZDR for LB</li>
					<li> Call Recording</li>
					<li> 2G only and 3G only enabled</li>
					<li> Advanced Power Menu</li>
					<li> Advanced Framework</li>
					<li> display carrier in status bar toggle</li>
					<li> ambient display</li>
					<li> marshmallow boot animation</li>
					<li> 42dip nav bar</li>
					<li> removed chrome -> added aosp browser (Much lightweight) with chrome bookmarks sync </li>
					<li> Patched services.jar --> SuperUser mod</li>
					<li> Mobile Radio Active Bug Fix</li>
					<li> Advanced Power Menu</li>
					<li> Themed SystemUI</li>
					<li> Dynamic navigation bar</li>
					<li> centered clock</li>
					<li> image in notification header</li>
					<li> Task manager button in status bar header</li>
					<li> Status bar signal icon fix</li>
					<li> Full Z5 Premium Apps Port</li>
					<li> Z5 Camera</li>
					<li> Init.d + Build.prop tweaks for better performance + battery</li>
					<li> Blackberry Priv apps in AROMA (read about it)</li>
					<li> Some small apps (here, here, here, here )</li>
					<li> YRom Settings menu and about (Include CPU Stats and settings)</li>
					<li> 42dip navigation bar</li>
					<li> fully rotatable screen (all angles)</li>
				</ul>
				</p>
            </div>
            <div id="sidebar">
